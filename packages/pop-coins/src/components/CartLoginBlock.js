              ...
              <View style={styles.block}>
                ...
                {isChecked
                  ...
                  <View>
                    {loading ? <Text>Loading...⏳</Text> :
                      <Text>
                        <Text style={{ fontWeight: '900' }}>Rs. {Math.floor(((brandData?.redemption_rate / 100) * cartTotalPrice)) < coinsData?.coins ? Math.round(((brandData?.redemption_rate / 100) * cartTotalPrice)) : coinsData?.coins} | Save Using BeanCoins</Text>
                        <Text>{"\n"}</Text>
                        <Text>(Cannot be clubbed with other discounts)</Text>
                      </Text>
                    }
